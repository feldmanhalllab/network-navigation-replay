...
if (knitting) {
  ggsave(
    filename = here(
      "outputs", "model-confusion", "bfs_backward_param_dist.pdf"
    ),
...
if (knitting) {
  ggsave(
    filename = here(
      "outputs", "model-confusion", "bfs_forward_param_dist.pdf"
    ),
...
if (knitting) {
  ggsave(
    filename = here(
      "outputs", "model-confusion", "ideal_obs_param_dist.pdf"
    ),
...
if (knitting) {
  ggsave(
    filename = here(
      "outputs", "model-confusion", "sr_param_dist.pdf"
    ),
    plot = plot_params_sr,
    width = 5, height = 2.5,
    units = "in", dpi = 300
